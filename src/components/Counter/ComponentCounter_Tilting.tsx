...
const ComponentCounter: React.FC<ComponentCounterProps> = ({ line, url, label, nameOpsi = null }) => {
    ...
    const APIURLs = {
        ...
        hourly: {
            ...
            shift2: `http://10.37.12.11:3000/shift2_${line}_tilting_hourly`,
            shift3: `http://10.37.12.11:3000/shift3_${line}_tilting_hourly`,
        },
    };
    ...
    const fetchShiftData = async () => {
        try {
            ...
            if (response.data) {
                setShiftData({
                    shift1: response.data.variance_shift1 || "0",
                                ...
                                <table className="w-full text-center border-collapse text-sm md:text-base lg:text-lg">
                                    <thead>
                                        <tr>
                                            ...
                                            <th className="border border-red-400 px-2 py-2 bg-red-100 whitespace-nowrap">
                                                <h4 className="text-red-900 text-base md:text-2xl font-extrabold">Variance</h4>
                                            </th>
                                        </tr>
                                    </thead>
