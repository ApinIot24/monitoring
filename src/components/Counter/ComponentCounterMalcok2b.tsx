...
const ComponentCounterMalcok2b: React.FC<ComponentCounterProps> = ({ line, url, label, nameOpsi = null }) => {
    ...
    const API = {
        packing: `http://10.37.12.11:3000/packing${line}`,
        shift: `http://10.37.12.11:3000/shift_l2b${productType}`,
        hourly: {
            shift1: `http://10.37.12.11:3000/shift1${line}_hourly`,
            shift2: `http://10.37.12.11:3000/shift2${line}_hourly`,
            shift3: `http://10.37.12.11:3000/shift3${line}_hourly`,
        },
    };
                                                        ...
                                                        <tr key={idx} className="hover:bg-red-50 transition">
                                                            ...
                                                            <td className={`border border-red-400 text-red-900 font-extrabold w-3/5 ${hourlyData.length > 4 ? 'text-5xl' : 'text-6xl'}`}>
                                                                <div className="flex flex-row items-center justify-center">
                                                                    <h3>{carton}</h3>
                                                                    <h3>({((carton / getTotalCarton(line)) * 100).toFixed(1)}%)</h3>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    );
